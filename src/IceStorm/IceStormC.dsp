...
# ADD LINK32 setargv.obj /nologo /subsystem:console /machine:I386 /out:"Release/icestormadmin.exe" /libpath:"../../../lib"
...
# ADD LINK32 setargv.obj /nologo /subsystem:console /debug /machine:I386 /out:"Debug/icestormadmin.exe" /pdbtype:sept /libpath:"../../../lib"

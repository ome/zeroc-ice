...
#define yy_create_buffer transform__create_buffer
#define yy_delete_buffer transform__delete_buffer
#define yy_scan_buffer transform__scan_buffer
#define yy_scan_string transform__scan_string
#define yy_scan_bytes transform__scan_bytes
#define yy_flex_debug transform__flex_debug
#define yy_init_buffer transform__init_buffer
#define yy_flush_buffer transform__flush_buffer
#define yy_load_buffer_state transform__load_buffer_state
#define yy_switch_to_buffer transform__switch_to_buffer
#define yyin transform_in
#define yyleng transform_leng
#define yylex transform_lex
#define yyout transform_out
#define yyrestart transform_restart
#define yytext transform_text
...
static yyconst short int yy_accept[52] =
    {   0,
       ...
       20,   21,   17,   15,   16,   25,   18,    6,    6,   25,
        9,   25,   10,    3,   22,   23,   14,    6,    6,    7,
        2,    1,    7,    6,    6,    0,    0,   24,   11,   13,
       12,    3,    6,    0,    7,    0,    7,    6,    0,    7,
        0
    } ;
...
static yyconst short int yy_base[56] =
    {   0,
        0,    0,   90,  103,  103,  103,   69,  103,  103,  103,
      103,  103,  103,   15,   18,   21,   29,   31,   26,   70,
       51,   50,   25,    0,  103,  103,  103,   34,   41,   49,
      103,  103,    0,   11,    0,   41,    0,  103,  103,  103,
      103,    0,   52,   50,  103,   59,   63,    0,   66,   69,
      103,   91,   95,   96,   99
    } ;
...
static yyconst short int yy_def[56] =
    {   0,
       ...
       51,   51,   30,   18,   19,   53,   54,   51,   51,   51,
       51,   52,   51,   55,   51,   51,   51,   54,   51,   51,
        0,   51,   51,   51,   51
    } ;
...
static yyconst short int yy_nxt[133] =
    {   0,
       ...
       29,   29,   28,   29,   29,   30,   30,   30,   31,   51,
       35,   35,   32,   33,   41,   34,   34,   35,   43,   43,
       29,   46,   46,   36,   51,   29,   29,   29,   36,   37,
       49,   49,   37,   30,   30,   30,   43,   43,   29,   40,
       39,   44,   45,   47,   47,   47,   44,   47,   47,   47,
       50,   50,   50,   50,   50,   50,   45,   38,   27,   51,
       51,   51,   45,   42,   42,   42,   47,   47,   48,   48,

       50,   50,    3,   51,   51,   51,   51,   51,   51,   51,
...
static yyconst short int yy_chk[133] =
    {   0,
       ...
       14,   14,   15,   15,   15,   16,   16,   16,   17,   34,
       19,   19,   17,   18,   23,   18,   18,   18,   28,   28,
       28,   36,   36,   18,   19,   29,   29,   29,   18,   18,
       44,   44,   28,   30,   30,   30,   43,   43,   43,   22,
       21,   30,   30,   46,   46,   46,   30,   47,   47,   47,
       49,   49,   49,   50,   50,   50,   47,   20,    7,    3,
        0,    0,   50,   52,   52,   52,   53,   53,   54,   54,
